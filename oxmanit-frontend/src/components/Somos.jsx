...
const process = [
  {
    ...
    description: "Entendemos el problema, las necesidades y el contexto antes de definir una solución.",
  },
  {
    number: "02",
    label: "Diseñar",
    title: "Diseño",
    description: "Definimos la arquitectura, la experiencia y el enfoque técnico antes de construir.",
  },
  {
    number: "03",
    label: "Construir",
    title: "Desarrollo",
    description: "Construimos, integramos y validamos cada parte de la solución.",
  },
  {
    number: "04",
    label: "Entregar",
    title: "Entrega & soporte",
    description: "Implementamos la solución y acompañamos su evolución cuando el proyecto lo requiere.",
  },
];
    ...
    <section id="nosotros" className="about-section">
      <div className="about-section__inner">
        <header className="about-header">
          <span className="about-header__eyebrow"><i /> 04 / Oxman IT</span>
          <div>
            <h2>Tecnología con propósito, construida de principio a fin.</h2>
            <p>Creamos soluciones claras, mantenibles y preparadas para evolucionar junto a cada proyecto.</p>
          </div>
        </header>
        ...
        <div className="about-statement">
          ...
          <div className="about-statement__copy">
            <p>
              La tecnología debe resolver problemas, no crear otros nuevos.
              En Oxman IT entendemos primero la necesidad, diseñamos una solución
        ...
        <div className="work-process">
          <header className="work-process__header">
            ...
            <p>Un proceso claro para avanzar desde el problema hasta una solución implementada y sostenible.</p>
          </header>
